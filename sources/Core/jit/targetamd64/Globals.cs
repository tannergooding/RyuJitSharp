...
public partial class Globals
{
    ...
    /// <summary>Registers no longer containing GC pointers after CORINFO_HELP_ASSIGN_BYREF.</summary>
    public const regMaskInt RBM_CALLEE_GCTRASH_WRITEBARRIER_BYREF = RBM_RAX | RBM_RCX;

    /// <summary>Registers killed by CORINFO_HELP_ASSIGN_BYREF.</summary>
    public const regMaskInt RBM_CALLEE_TRASH_WRITEBARRIER_BYREF = RBM_RSI | RBM_RDI | RBM_CALLEE_GCTRASH_WRITEBARRIER_BYREF;
