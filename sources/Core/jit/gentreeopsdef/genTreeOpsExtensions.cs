    ...
    extension(genTreeOps oper)
    {
        ...
        public GenTreeDebugOperKind DebugKind
        {
            get
            {
                ...
                return Unsafe.Add(ref MemoryMarshal.GetReference(s_debugKinds), (int)(oper));
            }
        }
#endif
        ...
        public GenTreeOperKind Kind
        {
            get
            {
                ...
                assert(oper < GT_COUNT);
                return Unsafe.Add(ref MemoryMarshal.GetReference(s_kinds), (int)(oper));
            }
        }
        ...
        public string Name
        {
            get
            {
                ...
                assert(oper < GT_COUNT);
                return Unsafe.Add(ref MemoryMarshal.GetArrayDataReference(s_names), (int)(oper));
            }
        }
#endif
        ...
        public string StructName
        {
            get
            {
                ...
                assert(oper < GT_COUNT);
                return Unsafe.Add(ref MemoryMarshal.GetArrayDataReference(s_structNames), (int)(oper));
            }
        }
#endif
    }
