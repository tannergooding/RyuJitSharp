...
public sealed class GenTreeAddrMode : GenTreeOp
{
    ...
    //
    //      Base                                // Base != null && Index == null && Scale == 0 && Offset == 0
    //      Base + Index*Scale                  // Base != null && Index != null && Scale != 0 && Offset == 0
    //      Base + Offset                       // Base != null && Index == null && Scale == 0 && Offset != 0
    //      Base + Index*Scale + Offset         // Base != null && Index != null && Scale != 0 && Offset != 0
    //             Index*Scale                  // Base == null && Index != null && Scale >  1 && Offset == 0
    //             Index*Scale + Offset         // Base == null && Index != null && Scale >  1 && Offset != 0
    //                           Offset         // Base == null && Index == null && Scale == 0 && Offset != 0
    //
    // So, for example:
