...
public partial struct JitConfigValues
{
    ...
    private static readonly unsafe FrozenDictionary<ConfigString, nint> ConfigStringMetadata = new Dictionary<ConfigString, nint> {
#if DEBUG
        [JitLsraOrdering] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitLsraOrdering"u8))),
        [JitInlineMethodsWithEHRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitInlineMethodsWithEHRange"u8))),
        [JitStressRegsRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitStressRegsRange"u8))),
        [JitLateDisasmTo] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitLateDisasmTo"u8))),
        [JitDumpFgDir] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitDumpFgDir"u8))),
        [JitDumpFgFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitDumpFgFile"u8))),
        [JitDumpFgPhase] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitDumpFgPhase"u8))),
        [JitDumpFgPrePhase] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitDumpFgPrePhase"u8))),
        [JitRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitRange"u8))),
        [JitStressModeNames] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitStressModeNames"u8))),
        [JitStressModeNamesAllow] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitStressModeNamesAllow"u8))),
        [JitStressModeNamesNot] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitStressModeNamesNot"u8))),
        [JitStressRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitStressRange"u8))),
        [JitEmitUnitTestsSections] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEmitUnitTestsSections"u8))),
        [JitDisasmAssemblies] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitDisasmAssemblies"u8))),
#endif

        [JitStdOutFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitStdOutFile"u8))),

#if DEBUG
        [WriteRichDebugInfoFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("WriteRichDebugInfoFile"u8))),
        [JitReplayCSE] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitReplayCSE"u8))),
        [JitReplayCSEReward] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitReplayCSEReward"u8))),
        [JitRLCSE] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitRLCSE"u8))),
        [JitRLCSEAlpha] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitRLCSEAlpha"u8))),
        [JitRLHookCSEDecisions] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitRLHookCSEDecisions"u8))),
#endif

#if OPT_CONFIG
        [JitEnableRboRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnableRboRange"u8))),
        [JitEnableHeadTailMergeRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnableHeadTailMergeRange"u8))),
        [JitEnableVNBasedDeadStoreRemovalRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnableVNBasedDeadStoreRemovalRange"u8))),
        [JitEnableEarlyLivenessRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnableEarlyLivenessRange"u8))),
        [JitOnlyOptimizeRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitOnlyOptimizeRange"u8))),
        [JitEnablePhysicalPromotionRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnablePhysicalPromotionRange"u8))),
        [JitEnableCrossBlockLocalAssertionPropRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnableCrossBlockLocalAssertionPropRange"u8))),
        [JitEnableInductionVariableOptsRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnableInductionVariableOptsRange"u8))),
        [JitEnableLocalAddrPropagationRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnableLocalAddrPropagationRange"u8))),
        [JitOptRepeatRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitOptRepeatRange"u8))),
        [JitAsyncDefaultValueAnalysisRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitAsyncDefaultValueAnalysisRange"u8))),
        [JitAsyncPreservedValueAnalysisRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitAsyncPreservedValueAnalysisRange"u8))),
        [JitAsyncReuseContinuationsRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitAsyncReuseContinuationsRange"u8))),
#endif

        [AltJitExcludeAssemblies] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("AltJitExcludeAssemblies"u8))),
        [JitFuncInfoFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitFuncInfoLogFile"u8))),
        [JitTimeLogCsv] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitTimeLogCsv"u8))),
        [JitTimeLogFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitTimeLogFile"u8))),
        [TailCallOpt] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("TailCallOpt"u8))),
        [JitMeasureNowayAssertFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitMeasureNowayAssertFile"u8))),

#if DEBUG
        [JitInlineDumpXmlFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitInlineDumpXmlFile"u8))),
        [JitNoInlineRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitNoInlineRange"u8))),
        [JitInlineReplayFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitInlineReplayFile"u8))),
        [JitObjectStackAllocationRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitObjectStackAllocationRange"u8))),
        [JitObjectStackAllocationConditionalEscapeRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitObjectStackAllocationConditionalEscapeRange"u8))),
        [JitObjectStackAllocationTrackFieldsRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitObjectStackAllocationTrackFieldsRange"u8))),
        [JitGuardedDevirtualizationRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitGuardedDevirtualizationRange"u8))),
        [JitEnableOsrRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnableOsrRange"u8))),
        [JitEnablePatchpointRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnablePatchpointRange"u8))),
        [JitInstrumentIfOptimizingRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitInstrumentIfOptimizingRange"u8))),
        [JitEnablePGORange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitEnablePGORange"u8))),
        [JitSynthesisExceptionWeight] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitSynthesisExceptionWeight"u8))),
        [JitFunctionFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitFunctionFile"u8))),
        [JitRawHexCodeFile] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitRawHexCodeFile"u8))),
#endif

#if DEBUG && TARGET_WASM
        [JitR2RUnsupportedRange] = (nint)(Unsafe.AsPointer(in MemoryMarshal.GetReference("JitR2RUnsupportedRange"u8))),
#endif
    }.ToFrozenDictionary();
}
