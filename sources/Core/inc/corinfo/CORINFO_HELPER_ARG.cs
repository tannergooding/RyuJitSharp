...
public struct CORINFO_HELPER_ARG
{
    ...
    [UnscopedRef]
    public unsafe ref CORINFO_FIELD_HANDLE fieldHandle => ref _anonymous.fieldHandle;

    [UnscopedRef]
    public unsafe ref CORINFO_METHOD_HANDLE methodHandle => ref _anonymous.methodHandle;

    [UnscopedRef]
    public unsafe ref CORINFO_CLASS_HANDLE classHandle => ref _anonymous.classHandle;
    ...
    public unsafe void Set(CORINFO_METHOD_HANDLE handle)
    {
        argType = CORINFO_HELPER_ARG_TYPE_Method;
        methodHandle = handle;
    }

    public unsafe void Set(CORINFO_FIELD_HANDLE handle)
    {
        argType = CORINFO_HELPER_ARG_TYPE_Field;
        fieldHandle = handle;
    }

    public unsafe void Set(CORINFO_CLASS_HANDLE handle)
    {
